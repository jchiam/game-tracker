...
// Verify against a community Endfield database on each patch. The operator catalog is
// generated by scripts/update-ae-data.mjs; absorbing weapons into that pipeline is
// deferred until a structured weapon source exists.
