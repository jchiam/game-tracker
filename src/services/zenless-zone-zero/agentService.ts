...
const svc = createRosterPersistence<ZzzAgent, ZzzTrackedAgent, ZzzAgentPatch>({
  ...
  select:
    'id, agent_id, level, mindscape, core_skill, skill_progress, is_favorited, disc_suit_4_id, disc_suit_2_id, disc_comments, wengine_id, wengine_level, wengine_phase, wengine_preferences',
  fromRow: (row, base) => ({
    ...base,
    dbId: row.id,
