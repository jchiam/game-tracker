...
Shared entity tracking lifecycle used by all game modules via `useRoster`. Covers loading from DB, optimistic add/remove with dedup guards, Fuse.js fuzzy search, and favorited-first sort.
