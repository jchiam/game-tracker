# Spec: hsr-imagekit-upload

## Purpose

Defines requirements for uploading Honkai Star Rail character and relic images to ImageKit CDN via the update script, exposing CDN URL resolution helpers, and removing local asset files from the repository once migration is confirmed.
