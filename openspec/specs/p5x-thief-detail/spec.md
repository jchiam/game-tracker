...
Awareness (0–6 duplicate ranks, shown as A0–A6), aggregate skill progress (two
coupled booleans — skills leveled to the Lv8 incense cap and rose-maxed past the
gate to Lv10 — with a rose-gated derived state), favorite toggle, level-based sort,
