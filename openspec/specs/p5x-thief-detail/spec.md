...
codename, personaName, role, element), and the Thief card's collapsed-summary
composition (investment-gradient chips, role/element badges, bound-Persona static
line, no rarity indicator). Edit sections and summary chips follow the dimension
ordering: Level → Weapon → Mindscape → Skills.
