...
forge), Mindscape progression (ordered 0–2: Outer maxed, then Inner = whole
tree), aggregate skill progression (ordered 0–2: Lv8 incense cap, then
rose-maxed to Lv10 — with a rose-gated derived state at 1), favorite toggle,
level-based sort, search keys (name,
