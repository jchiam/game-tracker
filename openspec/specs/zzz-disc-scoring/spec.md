# zzz-disc-scoring Specification

## Purpose

Disc equipment-match scoring for Zenless Zone Zero agents: a 0–100 score computed by a config adapter over the shared equipment-scoring core, covering the 4pc/2pc set term with same-suit spill, per-slot main-stat scoring, the ZZZ stat-shape vocabulary, and the score badge on the agent card.
