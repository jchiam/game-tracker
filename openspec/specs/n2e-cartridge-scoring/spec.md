...
Cartridge evaluation algorithm for Neverness to Everness. Scores an equipped cartridge against a character's stat preferences, producing a 0–100 score weighted between main stat (0.4) and sub stats (0.6) with game-specific partial match rules and letter grade thresholds.
