...
test.describe('Navigation', () => {
  test('brand title in navbar should navigate back to selection page from HSR page', async ({ page }) => {
    // Start at HSR page
  ...
  test('brand title in navbar should navigate back to selection page from Reverse 1999 page', async ({ page }) => {
