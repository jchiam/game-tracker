...
| `src/styles/controls.css`   | `.level-slider`/`.level-value`, `.spinner-dot`, `.stat-chip`, `.toggle-btn`, `.game-select`, `.segmented-buttons`, `.substats-section`/`.substat-row`, `.equip-slot-card`/`.equip-slot-header`, `.is-gated`, `.readonly-stat`, `.game-card-image` loading states                                                                                                                                                                                  |
