...
| File                        | Contents                                                                                                                                                                                                                                                                                        |
| --------------------------- | ----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| `src/styles/card.css`       | `.game-card` wrapper, header, overlay, controls, body, name, `.favorite-btn`, `.remove-btn`, `.edit-toggle-btn`, `.progress-section`, `.section-header`, `.equip-slot-grid`/`.equip-slot-cell`, the Target Build readout (`.build-prefs-display`, `.prefs-display-grid`, `.pref-stat-badge`, …) |
