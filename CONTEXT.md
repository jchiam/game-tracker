...
| Zenless Zone Zero        | `zzz`    | `zenless-zone-zero`     | **agent**           | Mindscape (M0–M6), Core Skill (cumulative A→F rungs, A first and F max; 0 = unenhanced), combat-skill maxed flags, specialty + exact-element taxonomy (open strings); 3-slot parties + party-level Bangboo Companion Slot |
